          ...
          <View style={styles.studentSection}>
            ...
            <View style={styles.studentInfo}>
              ...
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>{studentData.class_name || studentData.grade}</Text>
              </View>
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>Address</Text>
                <Text style={styles.infoValue}>{studentData.address || 'N/A'}</Text>
              </View>
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>Father's Name</Text>
                <Text style={styles.infoValue}>{studentData.fatherName || 'N/A'}</Text>
              </View>
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>Father's Phone</Text>
                <Text style={styles.infoValue}>{studentData.fatherPhone || 'N/A'}</Text>
              </View>
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>Mother's Name</Text>
                <Text style={styles.infoValue}>{studentData.motherName || 'N/A'}</Text>
              </View>
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>Mother's Phone</Text>
                <Text style={styles.infoValue}>{studentData.motherPhone || 'N/A'}</Text>
              </View>
            </View>
          </View>
